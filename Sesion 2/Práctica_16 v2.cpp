...
int main (){
	double esperanza, desviacion_tipica, valor_gaussiana, valor_abscisa_x, division, potencia_de_2, potencia_numero_e;
	...
	potencia_de_2 = ((valor_abscisa_x - esperanza) / desviacion_tipica) * ((valor_abscisa_x - esperanza) / desviacion_tipica);
	potencia_numero_e = exp(-0.5 * potencia_de_2);
